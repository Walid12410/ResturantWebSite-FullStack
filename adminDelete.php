...
<body>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="adminDelete.php">Delete-Product</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="hero-section">
        ...
        <div class="table-container">
            ...
            if (isset($_GET['id'])) {
                $sqlquerydelete = "DELETE FROM products WHERE productID=" . $_GET['id'];
            ...
            if ($result) {
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td><a href='adminDelete.php?id=" . $row['productID'] . "' class='btn btn-success'>Delete</a></td>";
                        echo "</tr>";
                    }
                    echo "</tbody>";
                    echo "</table>";
